...
cmd_iperf_server="sudo himage pc2@i3071 iperf -s -y >> dados.csv" #pc2
cmd_iperf_server2="sudo himage pc3@i3071 iperf -s -u" #pc3
cmd_iperf_server3="sudo himage pc4@i3071 iperf -s -u" #pc4
